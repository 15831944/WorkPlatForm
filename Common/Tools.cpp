...
namespace ZTools
{
	...
	*/
...
#ifdef USE_DLGLOG
	CPeraProcessDesignerApp* pApp = (CPeraProcessDesignerApp*)AfxGetApp();
	...
	BOOL CompareExtName(std::string strFileName, std::string strExtName)
	{
		ZTools::LowerString(strFileName);
		ZTools::LowerString(strExtName);
