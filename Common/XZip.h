...
//
ZRESULT ZipAdd(HZIP hz, const TCHAR *dstzn, void *src, unsigned int len, DWORD flags, int method = 8);
...
#define ZIP_MAX_PATH  MAX_PATH*2 // 文件名缓冲区
...
extern bool  UseOriginalFileTime ;
extern __int64  atime_memfile ;
extern __int64	mtime_memfile ;
extern __int64 ctime_memfile;
extern FILETIME ftm;
