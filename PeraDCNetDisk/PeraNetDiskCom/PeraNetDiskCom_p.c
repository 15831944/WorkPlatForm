...
typedef struct _PeraNetDiskCom_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } PeraNetDiskCom_MIDL_TYPE_FORMAT_STRING;

typedef struct _PeraNetDiskCom_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } PeraNetDiskCom_MIDL_PROC_FORMAT_STRING;

typedef struct _PeraNetDiskCom_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } PeraNetDiskCom_MIDL_EXPR_FORMAT_STRING;
...
extern const PeraNetDiskCom_MIDL_TYPE_FORMAT_STRING PeraNetDiskCom__MIDL_TypeFormatString;
extern const PeraNetDiskCom_MIDL_PROC_FORMAT_STRING PeraNetDiskCom__MIDL_ProcFormatString;
extern const PeraNetDiskCom_MIDL_EXPR_FORMAT_STRING PeraNetDiskCom__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO INetDiskCom_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO INetDiskCom_ProxyInfo;
...
static const PeraNetDiskCom_MIDL_PROC_FORMAT_STRING PeraNetDiskCom__MIDL_ProcFormatString =
    {
        0,
        {
...
static const PeraNetDiskCom_MIDL_TYPE_FORMAT_STRING PeraNetDiskCom__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: INetDiskCom, ver. 0.0,
   GUID={0xD6C9D706,0x8DE1,0x4DAF,{0xB1,0xE8,0xCD,0xF2,0xA9,0x28,0x0B,0xFC}} */

#pragma code_seg(".orpc")
static const unsigned short INetDiskCom_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO INetDiskCom_ProxyInfo =
    {
    &Object_StubDesc,
    PeraNetDiskCom__MIDL_ProcFormatString.Format,
    &INetDiskCom_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO INetDiskCom_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    PeraNetDiskCom__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _INetDiskComProxyVtbl = 
{
    &INetDiskCom_ProxyInfo,
    &IID_INetDiskCom,
    ...
    (void *) (INT_PTR) -1 /* INetDiskCom::InvokeMethod */
};


static const PRPC_STUB_FUNCTION INetDiskCom_table[] =
{
...
CInterfaceStubVtbl _INetDiskComStubVtbl =
{
    &IID_INetDiskCom,
    &INetDiskCom_ServerInfo,
    8,
    &INetDiskCom_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    PeraNetDiskCom__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _PeraNetDiskCom_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_INetDiskComProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _PeraNetDiskCom_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_INetDiskComStubVtbl,
    0
};

PCInterfaceName const _PeraNetDiskCom_InterfaceNamesList[] = 
{
    "INetDiskCom",
    0
};

const IID *  const _PeraNetDiskCom_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _PeraNetDiskCom_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PeraNetDiskCom, pIID, n)

int __stdcall _PeraNetDiskCom_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_PeraNetDiskCom_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo PeraNetDiskCom_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PeraNetDiskCom_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PeraNetDiskCom_StubVtblList,
    (const PCInterfaceName * ) & _PeraNetDiskCom_InterfaceNamesList,
    (const IID ** ) & _PeraNetDiskCom_BaseIIDList,
    & _PeraNetDiskCom_IID_Lookup, 
    1,
    2,
