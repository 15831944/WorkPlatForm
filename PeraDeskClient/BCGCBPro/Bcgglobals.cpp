...
static const CString strOffice2007FontName	= _T("宋体");
static const CString strDefaultFontName		= _T("宋体");
static const CString strVertFontName		= _T("宋体");
...
void BCGPGLOBAL_DATA::UpdateFonts()
{
	...
	lf.lfCharSet = lf.lfCharSet = ANSI_CHARSET; //(BYTE) GetTextCharsetInfo (dc.GetSafeHdc (), NULL, 0);

	lf.lfHeight = 12; //info.lfMenuFont.lfHeight;
	lf.lfWeight = FW_NORMAL; //info.lfMenuFont.lfWeight;
	...
	lstrcpy (lf.lfFaceName, "宋体"/*info.lfMenuFont.lfFaceName*/);
