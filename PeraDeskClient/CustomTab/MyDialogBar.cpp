...
// 		rect.left, rect.top, SRCCOPY);
	...
	CBrush brush;
	CBitmap bm;
	bm.LoadBitmap(IDB_TAB_WND_BK);
	brush.CreatePatternBrush(&bm);
	m_memDC.GetDC().FillRect(&rectClient, &brush);

// 	CBCGPDrawManager dm (m_memDC.GetDC());
// 	COLORREF clr1 = RGB(212,217,224);
// 	COLORREF clr2 = RGB(236,236,242);
// 	dm.FillGradient (rectClient, clr1, clr2, TRUE);
}
