...
const LPCTSTR viewflagTaskModel = _T("我的任务");
...
const LPCTSTR g_lpszAppTitle = _T("协同工作台");
//View-建模环境名称
const LPCTSTR g_lpszViewTitleTaskModel = _T("我的任务");
////View-管理监控名称
...
const COLORREF g_crBarBorderOut =RGB( 0xe9, 0xe9, 0xe9 ); //
