...
BEGIN_MESSAGE_MAP(CCxBCGPSplitterWnd, CBCGPSplitterWnd)
	ON_WM_MOUSEMOVE()
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(CCxBCGPSplitterWnd, CBCGPSplitterWnd)

CCxBCGPSplitterWnd::CCxBCGPSplitterWnd()
{
...
void CCxBCGPSplitterWnd::RecalcLayout()
{
...
void CCxBCGPSplitterWnd::StartTracking( int ht )
{
...
void CCxBCGPSplitterWnd::StopTracking( BOOL bAccept )
{
...
void CCxBCGPSplitterWnd::OnMouseMove(UINT /*nFlags*/, CPoint pt)
{
	if (GetCapture() != this)
		StopTracking(FALSE);
...
void CCxBCGPSplitterWnd::GetHitRect(int ht, CRect& rectHit)
{
	ASSERT_VALID(this);
