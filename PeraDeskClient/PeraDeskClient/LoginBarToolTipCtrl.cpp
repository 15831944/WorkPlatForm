...
CString CLoginBarToolTipCtrl::m_strClassName;

BEGIN_MESSAGE_MAP(CLoginBarToolTipCtrl, CWnd)
	ON_WM_ERASEBKGND()
	ON_WM_PAINT()
	ON_MESSAGE(WM_SETFONT, OnSetFont)
END_MESSAGE_MAP()

IMPLEMENT_DYNAMIC(CLoginBarToolTipCtrl, CWnd)

CLoginBarToolTipCtrl::CLoginBarToolTipCtrl(void)
{
...
BOOL CLoginBarToolTipCtrl::Create (CWnd* pWndParent) 
{
...
BOOL CLoginBarToolTipCtrl::OnEraseBkgnd(CDC* /*pDC*/) 
{
	return TRUE;
}
...
//*******************************************************************************************
void CLoginBarToolTipCtrl::Hide ()
{
	if (GetSafeHwnd () != NULL)
	{
		ShowWindow (SW_HIDE);
...
//*******************************************************************************************
void CLoginBarToolTipCtrl::Deactivate ()
{
	m_strText.Empty ();
	m_rectLast.SetRectEmpty ();
...
//*****************************************************************************
LRESULT CLoginBarToolTipCtrl::OnSetFont (WPARAM wParam, LPARAM lParam)
{
...
//***************************************************************************
BOOL CLoginBarToolTipCtrl::PreTranslateMessage(MSG* pMsg) 
{
...
CString * CLoginBarToolTipCtrl::SplitString(CString str, char split, int& iSubStrs)
{
	int iPos = 0; //分割符位置
	int iNums = 0; //分割符的总数
	CString strTemp = str;
...
//绘制多行文本
void CLoginBarToolTipCtrl::DrawTextML(CDC& dc, CString& str, CRect& rect)
{
	CRect rectDraw;
	CString strLine;
