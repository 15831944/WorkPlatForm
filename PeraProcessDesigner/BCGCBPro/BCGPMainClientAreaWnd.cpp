...
CBCGPMDITabParams::CBCGPMDITabParams ()
{
	...
	m_bSetActiveTabBoldFont = TRUE;
	m_nTabMinFullWidth      = 0;
	m_bEnableDragTab		= TRUE;
}
...
void CBCGPMainClientAreaWnd::ApplyParams (CBCGPTabWnd* pTabWnd)
{
	...
	if ( m_mdiTabParams.m_bSetActiveTabBoldFont )
	...
	pTabWnd->m_nMinFullWidth = m_mdiTabParams.m_nTabMinFullWidth;
	pTabWnd->m_bEnableDragTab = m_mdiTabParams.m_bEnableDragTab;
