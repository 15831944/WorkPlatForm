...
public:
	...
	BOOL CreateCacheByWS( LPCTSTR lpRunId, LPCTSTR lpWsPath, BOOL bAsync = TRUE );
	BOOL CreateWSByCache( LPCTSTR lpRunId, LPCTSTR lpWsPath, BOOL bAsync = TRUE );
	BOOL CopyCache( LPCTSTR lpCachedirId, LPCTSTR lpRunId, BOOL bAsync = TRUE );
	BOOL DeleteCache( LPCTSTR lpRunId, BOOL bAsync = TRUE );
	BOOL CreateCacheByXpdlStream( LPCTSTR lpRunId, LPCTSTR lpXpdlStream, BOOL bAsync = TRUE );
	BOOL CreateWSByXpdlStream( LPCTSTR lpRunId, LPCTSTR lpWsPath, LPCTSTR lpXpdlStream, BOOL bAsync = TRUE );
...
extern CPeraWsAstIceClient_I g_IceWsAstClient;