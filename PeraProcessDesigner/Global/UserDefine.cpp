...
const LPCTSTR viewflagJobMgr = _T("历史监控");
...
//View-管理监控名称
const LPCTSTR g_lpszViewTitleJobMgr = _T("作业管理");
//View-分布式资源管理名称
...
const LPCTSTR g_lpszDoubleOpenWsMemName = "WS_IsCanDoubleOpenwsMemoryName";
//是否可以发送打开ws文件命令行标记共享内存内容
const LPCTSTR g_lpszDoubleOpenWsMemStr = "CannotDoubleOpenws";
//单机版建模运行，查找执行环境进程名
const LPCTSTR g_lpszWSRunnerProcessName = "PeraProcessRunner.exe";
//单机版建模运行，查找执行环境,Caption模糊查找
const LPCTSTR g_lpszWSRunnerFindCaption = "执行环境";
