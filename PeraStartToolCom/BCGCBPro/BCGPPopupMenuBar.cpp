...
COLORREF CBCGPPopupMenuBar::m_crPeraBg = globalData.clrBtnFace;
...
void CBCGPPopupMenuBar::DoPaint( CDC* pDCPaint )
{
	...
	pHotImages->SetTransparentColor ( m_crPeraBg );
...
pDisabledImages : pHotImages;
				...
				if (bDrawImages && pNewImages != pImages && pNewImages != NULL)
				{
					...
					pNewImages->SetTransparentColor ( m_crPeraBg );
