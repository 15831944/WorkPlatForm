...
typedef struct _PeraStartToolCom_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } PeraStartToolCom_MIDL_TYPE_FORMAT_STRING;

typedef struct _PeraStartToolCom_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } PeraStartToolCom_MIDL_PROC_FORMAT_STRING;

typedef struct _PeraStartToolCom_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } PeraStartToolCom_MIDL_EXPR_FORMAT_STRING;
...
extern const PeraStartToolCom_MIDL_TYPE_FORMAT_STRING PeraStartToolCom__MIDL_TypeFormatString;
extern const PeraStartToolCom_MIDL_PROC_FORMAT_STRING PeraStartToolCom__MIDL_ProcFormatString;
extern const PeraStartToolCom_MIDL_EXPR_FORMAT_STRING PeraStartToolCom__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IToolCore_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IToolCore_ProxyInfo;
...
static const PeraStartToolCom_MIDL_PROC_FORMAT_STRING PeraStartToolCom__MIDL_ProcFormatString =
    {
        0,
        {
...
static const PeraStartToolCom_MIDL_TYPE_FORMAT_STRING PeraStartToolCom__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IToolCore, ver. 0.0,
   GUID={0x2974AC23,0x9791,0x4C55,{0xA3,0x78,0xB2,0x7A,0xFB,0x6F,0x4D,0x48}} */

#pragma code_seg(".orpc")
static const unsigned short IToolCore_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IToolCore_ProxyInfo =
    {
    &Object_StubDesc,
    PeraStartToolCom__MIDL_ProcFormatString.Format,
    &IToolCore_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IToolCore_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    PeraStartToolCom__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(12) _IToolCoreProxyVtbl = 
{
    &IToolCore_ProxyInfo,
    &IID_IToolCore,
    ...
    (void *) (INT_PTR) -1 /* IToolCore::InvokeApp */ ,
    (void *) (INT_PTR) -1 /* IToolCore::ManageApp */ ,
    (void *) (INT_PTR) -1 /* IToolCore::ConfigApp */ ,
    (void *) (INT_PTR) -1 /* IToolCore::InvokeAppById */ ,
    (void *) (INT_PTR) -1 /* IToolCore::OpenUrl */
};


static const PRPC_STUB_FUNCTION IToolCore_table[] =
{
...
CInterfaceStubVtbl _IToolCoreStubVtbl =
{
    &IID_IToolCore,
    &IToolCore_ServerInfo,
    12,
    &IToolCore_table[-3],
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    PeraStartToolCom__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _PeraStartToolCom_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IToolCoreProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _PeraStartToolCom_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IToolCoreStubVtbl,
    0
};

PCInterfaceName const _PeraStartToolCom_InterfaceNamesList[] = 
{
    "IToolCore",
    0
};

const IID *  const _PeraStartToolCom_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _PeraStartToolCom_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _PeraStartToolCom, pIID, n)

int __stdcall _PeraStartToolCom_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_PeraStartToolCom_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo PeraStartToolCom_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _PeraStartToolCom_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _PeraStartToolCom_StubVtblList,
    (const PCInterfaceName * ) & _PeraStartToolCom_InterfaceNamesList,
    (const IID ** ) & _PeraStartToolCom_BaseIIDList,
    & _PeraStartToolCom_IID_Lookup, 
    1,
    2,
