...
{
	CString strFile;
	strFile.Format("%s\\dump\\Dump_PeraPcIceClient_%s.dmp", ZTools::GetCurrentModulePath().c_str(), GuidToString(CreateGuid()).c_str());
	MakeSureDirectoryPathExists(strFile);
